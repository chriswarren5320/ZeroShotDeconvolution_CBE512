...
python Train_ZSDeconvNet_2D.py  --upsample_flag 1 \
                                --otf_or_psf_path "E:\Christopher\ZSD\train_inference_python\20251114\PSF.tif" \
                                --psf_src_mode 1 \
                                --dxypsf 1 \
                                --dx 1 \
                                --dy 1 \
                                --data_dir "E:\Christopher\ZSD\train_inference_python\20251114\data\\" \
                                --folder 'd1' \
                                --test_images_path "E:\Christopher\ZSD\train_inference_python\20251114\data\\d1\input\cell01_reco1_00000001.tif" \
                                --save_weights_dir "E:\Christopher\ZSD\train_inference_python\20251114\weights" \
                                --save_weights_suffix '_2000_iter' \
                                --iterations 20000 \
                                --batch_size 16
